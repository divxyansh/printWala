                ...
                <div className='grid grid-cols-1 gap-y-8 border-b border-gray-200 py-8 sm:grid-cols-2 sm:gap-x-6 sm:py-6 md:py-10'>
                    ...
                    <div>
                        ...
                        <ol className='mt-3 text-zinc-700 list-disc list-inside'>
                            ...
                            <li>Scratch and fringer-print resistant coating</li>
                        </ol>
                    </div>
                </div>
                <div className='mt-8'>
                    <div className='bg-gray-50 p-6 sm:rounded-lg sm:p-8'>
                        <div className='flow-root text-sm'>
                            ...
                            {finish==="textured" ?(
                                ...
                                <p className='font-medium text-gray-900'>₹{FINISHES.options[1].price}</p>
                            </div>
                            ):null}
                            {material==="polycarbonate" ?(
                                <div className='flex items-center justify-between py-1 mt-2'>
                                <p className='text-gray-600'>Soft Polycarbonate material</p>
                                <p className='font-medium text-gray-900'>₹{MATERIALS.options[1].price}</p>
                            </div>
                            ):null}
                    ...
                    <div className='mt-8 flex justify-end pb-12'>
                        <Button onClick={()=>handleCheckout()} className='px-4 sm:px-6 lg:px-8 '>Check out <ArrowRight className='h-4 w-4'/></Button>
                    </div>
                </div>
            </div>
        </div>
